...
const Quiz = ({ videoRef }) => {
    ...
    const [selectedValue, setSelectedValue] = useState(''); // Add this state
    ...
    }, [videoRef, handleSubmit]); // Include videoRef and handleSubmit in the dependency array
                    ...
                    <div className="question-option-container">
                        ...
                        <div className="option-container">
                            {questionDetails[count].options.map((option, idx) => {
                                return (
                                    <div className="radio-button" key={idx.toString()}>
                                        <RadioButton
